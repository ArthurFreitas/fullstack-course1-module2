...
class LineAnalyzer
  ...
  def calculate_word_frequency()
    ...
    @highest_wf_words = word_frequency.select{|k,v| v == @highest_wf_count}.map{|k,v| k}
  end
end
...
class Solution
  ...
  # Implement the following read-only attributes in the Solution class.calculate_word_frequency
